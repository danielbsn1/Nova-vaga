...
from app.api.v1 import empresas, freelancers, vagas, pagamentos
from backend.app.api.v1 import auth1

router = APIRouter()

router.include_router(auth1.router, prefix="/auth", tags=["auth"])
